...
public class EmailFlowIT {
    ...
    public void testCreateOrganizationAndAdminWithConfirmationOnly() throws Exception {
        ...
        assertEquals( ActivationState.ACTIVATED,
                setup.getMgmtSvc().handleConfirmationTokenForAdminUser( org_owner.getOrganization().getUuid(), org_owner.owner.getUuid(), token ) );
    ...
    public void testCreateOrganizationAndAdminWithConfirmationAndActivation() throws Exception {
        ...
        state = setup.getMgmtSvc().handleActivationTokenForAdminUser( org_owner.getOrganization().getUuid(), org_owner.owner.getUuid(), token );
